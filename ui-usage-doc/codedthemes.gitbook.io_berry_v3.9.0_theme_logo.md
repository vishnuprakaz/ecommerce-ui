---
url: "https://codedthemes.gitbook.io/berry/v3.9.0/theme/logo"
title: "Logo | Berry React"
---

### [Direct link to heading](https://codedthemes.gitbook.io/berry/v3.9.0/theme/logo\#logo-from-assets-images-directory-or-public-directory)    Logo from assets/images directory or public directory
...
### [Direct link to heading](https://codedthemes.gitbook.io/berry/v3.9.0/theme/logo\#use-logo-internally-using-svg-element)    Use Logo internally using svg element
    ...
    return (
        <svg width="92" height="32" viewBox="0 0 92 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                fill={theme.palette.mode === ThemeMode.DARK ? theme.palette.common.white : theme.palette.grey[900]}
            />
            <path
